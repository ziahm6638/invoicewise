...
export const TrialEndedEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Your InvoiceWise trial has now ended, which means you have read-only access.`;
    ...
    <EmailThemeProvider preview={<Preview>{text}</Preview>}>
      ...
      >
        ...
        >
          ...
          >
            Your InvoiceWise Trial Has Ended
          </Heading>
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Your InvoiceWise trial has now ended, which means you have read-only
            access.
          </Text>
          <Text
          ...
          >
            ...
            InvoiceWise a try. We won't send any more emails, but you're always
            welcome back.
          </Text>
          <Text
            className={`text-[14px] ${themeClasses.text}`}
