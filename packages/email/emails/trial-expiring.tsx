...
export const TrialExpiringEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Just a quick reminder—your InvoiceWise trial ends in 3 days. We hope you've had a great experience so far.`;
    ...
    <EmailThemeProvider preview={<Preview>{text}</Preview>}>
      ...
      >
        ...
        >
          ...
          >
            Your InvoiceWise Trial is Expiring Soon
          </Heading>
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Just a quick reminder—your InvoiceWise trial ends in 3 days. We hope
