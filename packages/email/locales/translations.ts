  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on InvoiceWise`,
        "invite.preview": `Join ${params?.teamName} on InvoiceWise`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på InvoiceWise`,
        "invite.preview": `Gå med i ${params?.teamName} på InvoiceWise`,
