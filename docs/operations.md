...
| TypeSafe calls | 2000 per UTC day in production, 300 in staging; when spent, document processing and question reruns stay queued until 00:00 UTC while every other workflow runs | `TYPESAFE_DAILY_CALL_LIMIT` |
