...
type Props = {
  // Pending invitations are listed to owners and admins only; the server
  // enforces the same rule on `team.teamInvites`.
  canManageMembers: boolean;
};

export function TeamMembers({ canManageMembers }: Props) {
  if (!canManageMembers) {
    return (
